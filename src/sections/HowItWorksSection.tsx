...
const STEPS = [
  ...
  },
  {
    ...
    num: "02",
    title: "Запусти",
    text: "Открой OpenChanger вместе с Dota 2 — программа сама всё подхватит за пару секунд.",
  },
  {
    icon: Wand2,
    num: "03",
    title: "Выбери скин",
    text: "Кликни по любому скину из библиотеки — и он сразу появится у тебя в игре.",
  },
];
